...
import (
	apiv1alpha3 "github.com/aws/etcdadm-controller/internal/thirdparty/api/v1alpha3"
...
func (in *EtcdadmClusterSpec) DeepCopyInto(out *EtcdadmClusterSpec) {
	*out = *in
	...
	in.EtcdadmConfigSpec.DeepCopyInto(&out.EtcdadmConfigSpec)
}
